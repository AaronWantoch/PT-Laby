...
public class InitializeTestData {
    ...
    public void init() {
        ...
        skillService.create(attack);
        skillService.create(backStab);
        skillService.create(heal);
        skillService.create(charm);
        skillService.create(heavyAttack);
...
//        professionService.create(duplicate);//Causes primary key violation
